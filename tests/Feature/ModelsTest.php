...
final class ModelsTest extends TestCase
{
    public function test_report_casts_status_and_priority(): void
    {
        ...
        self::assertSame(Priority::High, $report->priority);
        self::assertSame(ReportStatus::New, $report->status);
    }
    ...
    public function test_case_can_link_reports(): void
    {
        ...
        $case->reports()->attach($report);
        self::assertSame(1, $case->reports()->count());
    }
}
